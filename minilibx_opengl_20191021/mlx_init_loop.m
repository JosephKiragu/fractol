...
void *mlx_init()
{
  ...
  // load font
  new_mlx->font = mlx_new_image(new_mlx, (FONT_wid+2)*95, FONT_HEIGHT);
  i = 0;
  while (i < 4*(FONT_wid+2)*95*FONT_HEIGHT)
    {
...
#ifdef	STRINGPUTX11
  new_mlx->font->vertexes[2] = FONT_wid/1.4;
  new_mlx->font->vertexes[4] = FONT_wid/1.4;
  new_mlx->font->vertexes[5] = (-FONT_HEIGHT-1)/1.4;
  new_mlx->font->vertexes[7] = (-FONT_HEIGHT-1)/1.4;
#else
  new_mlx->font->vertexes[2] = FONT_wid;
  new_mlx->font->vertexes[4] = FONT_wid;
